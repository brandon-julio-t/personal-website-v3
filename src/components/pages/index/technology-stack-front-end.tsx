  ...
  return (
    <section className="text-center">
      ...
      <ul className="my-1">
          ...
          <svg className="h-5" xmlns="http://www.w3.org/2000/svg" viewBox="0 0 179.2 192.7">
            <g data-name="Layer 2">
              <g data-name="Layer 1">
                ...
                />
                <polygon style={{ fill: '#ffe0b2' }} points="102.9 146.3 39.6 115.8 75.9 93.4 139.6 124 102.9 146.3" />
                <polygon style={{ fill: '#fff3e0' }} points="102.9 122.8 39.6 92.2 75.9 69.9 139.6 100.5 102.9 122.8" />
                <polygon style={{ fill: '#fff' }} points="102.9 99.3 39.6 68.7 75.9 46.3 139.6 76.9 102.9 99.3" />
              </g>
            </g>
          </svg>
        ...
        <TechnologyStackListItem>
          <svg className="h-5" xmlns="http://www.w3.org/2000/svg" viewBox="0 0 128 128">
            <path style={{ fill: '#1FA6CA' }} d="M0.2,68.6V13.4L48,41v18.4L16.1,41v36.8L0.2,68.6z" />
            <path style={{ fill: '#1C7FB6' }} d="M48,41l47.9-27.6v55.3L64,87l-16-9.2L80,59.4V41L48,59.4V41z" />
            <path style={{ fill: '#1FA6CA' }} d="M48,77.8v18.4L80,114.6V96.2L48,77.8z" />
            <path
              style={{ fill: '#1C7FB6' }}
        ...
        <TechnologyStackListItem>
          <svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 400 298" className="h-5">
        ...
        <TechnologyStackListItem>
          <svg xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 54 33" className="h-5">
        ...
        <TechnologyStackListItem>
          <svg className="h-5" viewBox="26.69 28.9 1173.9 1144.1" xmlns="http://www.w3.org/2000/svg">
